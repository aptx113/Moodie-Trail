...
set CLASSPATH=%APP_HOME%\lib\detekt-cli-1.9.1.jar;%APP_HOME%\lib\kotlin-stdlib-jdk8-1.3.72.jar;%APP_HOME%\lib\detekt-core-1.9.1.jar;%APP_HOME%\lib\jcommander-1.78.jar;%APP_HOME%\lib\kotlinx-html-jvm-0.7.1.jar;%APP_HOME%\lib\detekt-rules-1.9.1.jar;%APP_HOME%\lib\kotlin-stdlib-jdk7-1.3.72.jar;%APP_HOME%\lib\detekt-metrics-1.9.1.jar;%APP_HOME%\lib\detekt-api-1.9.1.jar;%APP_HOME%\lib\kotlin-compiler-embeddable-1.3.72.jar;%APP_HOME%\lib\kotlin-reflect-1.3.72.jar;%APP_HOME%\lib\kotlin-stdlib-1.3.72.jar;%APP_HOME%\lib\kotlinx-html-common-0.7.1.jar;%APP_HOME%\lib\kotlin-stdlib-common-1.3.72.jar;%APP_HOME%\lib\annotations-13.0.jar;%APP_HOME%\lib\snakeyaml-1.26.jar;%APP_HOME%\lib\kotlin-script-runtime-1.3.72.jar;%APP_HOME%\lib\kotlin-daemon-embeddable-1.3.72.jar;%APP_HOME%\lib\trove4j-1.0.20181211.jar
