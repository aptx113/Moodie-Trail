    ...
    override fun onCreateView(
        ...
        val noteList = listOf(
            Note(
                ...
                "9526", 20200202, 1, listOf(), listOf(), "喵喵喵喵喵喵喵喵喵喵喵喵喵喵喵喵", null, "https://storage.googleapis.com/petsmao-images/images/2019/10/5a56af32-1571795279-a7d32647e0a334efbedeb39fdbad225a.jpg",
                listOf()
            )
            , Note(
